...
<!-- Mirrored from bucketadmin.themebucket.net/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Feb 2016 11:24:39 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <?php
                    $user = $this->session->userdata('logininfo');                            
                    $user = $user['username'];
                ?>
                <span class="username">
                    <?php
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="<?php echo base_url();?>admin_auth/logout"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
